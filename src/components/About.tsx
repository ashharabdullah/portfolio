            ...
            <div className=" w-full  md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                ...
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">I hold a degree in Computer Science and I am focusing on technologies React,Next.js, Node.js and Tailwind CSS</p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"> </div>
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">As a fullstack Web Developer, I specialize in Salesforce, React JS, Next JS, Node JS, Tailwind CSS and Bootstrap CSS. My expertise extends to creating responsive, user-friendly interfaces and efficient backend solutions.</p>
                    </div>
                </div>
            </div>
